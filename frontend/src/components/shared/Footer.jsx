...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-4 bg-gray-700 text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          {/* Career Sphere Section */}
          <div className="flex flex-col items-start">
            <h2 className="text-xl font-bold">Career Sphere</h2>
